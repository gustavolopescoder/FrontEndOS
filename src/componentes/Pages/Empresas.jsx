...
function Empresas() {
  ...
  const salvarEmpresa = () => {
    ...
    const url = empresaEditandoId
      ? `https://backendos-production.up.railway.app/empresas/${empresaEditandoId}`
      : "https://backendos-production.up.railway.app/empresas/";
  ...
  const alternarStatusEmpresa = (id, statusAtual) => {
    ...
    fetch(`https://backendos-production.up.railway.app/empresas/${id}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
