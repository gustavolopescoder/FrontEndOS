...
function Tecnicos({ usuarioLogado }) {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backendos-production.up.railway.app/tecnicos", {
        headers: {
  ...
  const adicionarTecnico = async () => {
    ...
    try {
      const res = await axios.post(
        "https://backendos-production.up.railway.app/tecnicos",
        {
          nome,
          email,
          senha,
  ...
  const salvarEdicao = async () => {
    ...
    try {
      ...
      await axios.put(
        `https://backendos-production.up.railway.app/tecnicos/${tecnicoEditandoId}`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const onDesativar = async (id) => {
    ...
    try {
      await axios.put(
        `https://backendos-production.up.railway.app/${id}/status`,
        { ativo: novoStatus },
        {
          headers: {
            Authorization: `Bearer ${token}`,
